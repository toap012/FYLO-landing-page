<template>
	<section class="main-body-layout">
		<section class="first-layout">
			<img src="src/assets/img/folder.png" alt="">
			<p class="header big">All your files in one secure location, accessible anywhere.</p>
			<p class="main">Fylo stores all your most important files in one secure location. Access them wherever you need,
				share and collaborate with friends family, and co-workers.</p>
			<button>Get Started</button>
		</section>
		<section class="secondery-layout">
			<section class="gallery">
				<article>
						...
						<g fill="none" fill-rule="evenodd">
							...
							<g transform="translate(55.377 23.07)" stroke="#62E0D9">
								<rect stroke-width="1.641" fill="#181F2B" x=".821" y=".821" width="25.621" height="52.795"
									rx="2.462" />
								<path stroke-width="1.458" fill="#FFF"
					...
					<p class="header small">Access your files, anywhere</p>
				...
				<article>
					...
					<p class="header small">Security you can trust</p>
				...
				<article>
					...
					<p class="header small">Real-time collaboration</p>
				...
				<article>
					...
					<p class="header small">Store any type of file</p>
		...
		<section class="third-layout">
			<img src="src/assets/img/illustration-stay-productive.png" alt="">
			<article>
				<p class="header big">Stay productive,
					<br />wherever you are
				</p>
